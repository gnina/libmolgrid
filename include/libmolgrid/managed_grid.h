...
namespace libmolgrid
{
  ...
  public:
    ...
    bool ongpu() const
    {
      ...
      if (ret && gpu_grid.data() == nullptr)
        togpu(); // needed if this is a copy made before another transfered
      return ret;
    }
  ...
  protected:
    ...
    explicit ManagedGridBase(const ManagedGridBase<Dtype, NumDims + 1> &G, size_t i) : gpu_grid(G.gpu_grid, i), cpu_grid(G.cpu_grid, i), cpu_ptr(G.cpu_ptr),
